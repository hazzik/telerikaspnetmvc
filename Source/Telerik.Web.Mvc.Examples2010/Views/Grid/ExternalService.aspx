...
<asp:Content contentPlaceHolderID="ExampleTitle" runat="server">Binding to External Web Service</asp:Content>
...
<style type="text/css">
	.twitter-icon
	{
		background: url('<%= ResolveUrl("~/Content/Grid/ExternalService/twitter-logo.png") %>') no-repeat 0 0;
		width: 100px;
		height: 25px;
		line-height: 25px;
