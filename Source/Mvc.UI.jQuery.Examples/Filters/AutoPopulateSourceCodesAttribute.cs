    ...
    public class AutoPopulateSourceCodesAttribute : FilterAttribute, IResultFilter
    {
        ...
        public void OnResultExecuting(ResultExecutingContext filterContext)
        {
            ...
            if (viewResult != null)
            {
                ...
                string viewVirtualPath = BaseViewPath + controllerName + Path.AltDirectorySeparatorChar + viewName + ".aspx";
                string viewPhysicalPath = server.MapPath(viewVirtualPath);

                string masterPageVirtualPath = BaseViewPath + "Shared" + Path.AltDirectorySeparatorChar + "Site.Master";
