namespace Telerik.Web.Mvc.UI.UnitTest
{
    ...
    public static class DropDownListTestHelper
    {
        ...
        public static DropDownList CreateDropDownList(IDropDownListHtmlBuilder renderer)
        {
            ...
            Mock<IDropDownListHtmlBuilderFactory> DropDownListRendererFactory = new Mock<IDropDownListHtmlBuilderFactory>();
            ...
            DropDownList dropDownList = new DropDownList(viewContext, clientSideObjectWriterFactory.Object, urlGenerator, DropDownListRendererFactory.Object); // authorization.Object

            renderer = renderer ?? new DropDownListHtmlBuilder(dropDownList);
            DropDownListRendererFactory.Setup(f => f.Create(It.IsAny<DropDownList>())).Returns(renderer);
