...
<script type="text/javascript">
    ...
    test('roudWidths with 156px width and small step 1 must return 10 steps', function () {
        var slider = $("#Slider4").data("tSlider");
        
        slider.position = slider.orientation == "horizontal" ? "left" : "bottom";
        slider.size = slider.orientation == "horizontal" ? "width" : "height";
        
        var getPixelSteps = $t.slider.getPixelSteps(slider.wrapper, slider);

        equal(10, getPixelSteps.length);
    });

    test('roudWidths with 200px width and small step 1 must return 10 steps', function () {
        var slider = $("#Slider4").data("tSlider");
        
        slider.position = slider.orientation == "horizontal" ? "left" : "bottom";
        slider.size = slider.orientation == "horizontal" ? "width" : "height";

        slider.wrapper.find('.t-slider-track').css(slider.size, "200");
        
        var getPixelSteps = $t.slider.getPixelSteps(slider.wrapper, slider);

        equal(10, getPixelSteps.length);

        slider.wrapper.find('.t-slider-track').css(slider.size, "156");
    });

    test('roudWidths with 200px width and small step 2 must return 5 steps', function () {
        var slider = $("#Slider4").data("tSlider");
    ...
    test('roudWidths with 100px width and small step 2 must return 5 steps', function () {
        var slider = $("#Slider4").data("tSlider");
        ...
        slider.wrapper.find('.t-slider-track').css(slider.size, "100");
