            ...
            .Items(menu =>
            {
                ...
                menu.Add()
                    ...
                    {%>
                        ...
                        <a id="buy" href="http://www.telerik.com/purchase/individual/orm.aspx">Telerik OpenAccess ORM</a>
                        <a id="express" href="http://www.telerik.com/community/license-agreement.aspx?pId=639">Telerik OpenAccess ORM Express</a>
                    <%});
