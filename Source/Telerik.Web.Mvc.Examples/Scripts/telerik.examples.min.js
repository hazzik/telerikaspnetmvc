function navigateOnSearch(e) {
    if (e.value.split('/').length == 2)
        location.href = examplesBaseUrl + e.value;
}
...
$(function () {
    ...
    var availableSkins = 'Black,Default,Forest,Hay,Office2007,Outlook,Simple,Sitefinity,Sunset,Telerik,Vista,Web20,WebBlue,Windows7'.split(',');
    ...
    $('.configurator .t-button, .accessibility-validation .t-button')
    ...
    $('#examples-search')
        .find('.t-input')
            .focus(function () {
                $('#examples-search label').hide();
            })
            .blur(function () {
                $('#examples-search label').show();
            });
