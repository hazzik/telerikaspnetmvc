namespace Telerik.Web.Mvc.UnitTest
{
    ...
    public class SiteMapHandlerTests
    {
        ...
        private void Process(Mock<Stream> outputStream)
        {
                                                                                                 ...
                                                                                                 .ChildNodes(childNode =>
                                                                                                                             {
                                                                                                                                 childNode.Add()
                                                                                                                                          .Title("Product1")
                                                                                                                                          .Action("Product", "Detail", new { id = 1 });

                                                                                                                                 childNode.Add()
                                                                                                                                          .Title("Product2")
                                                                                                                                          .Action("Product", "Detail", new { id = 2 });
                                                                                                                             }
                                                                                                            );
            ...
            _urlGenerator.Setup(generater => generater.Generate(It.IsAny<RequestContext>(), It.IsAny<INavigationItem>())).Returns("http://localhost/Griffin/Home").Verifiable();
