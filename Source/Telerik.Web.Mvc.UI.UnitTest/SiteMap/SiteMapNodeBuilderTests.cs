namespace Telerik.Web.Mvc.UnitTest
{
    ...
    public class SiteMapNodeBuilderTests
    {
        ...
        [Fact]
        public void RadSiteMapNode_operator_should_return_correct_site_map_node()
        {
        ...
        public void Should_be_able_to_set_action_with_route_value_dictionary()
        {
            ...
            _builder.Action("dummy","action", values);
        ...
        {
            _builder.Action("dummy", "action", new { foo = "bar" });
