namespace Telerik.Web.Mvc.UI.Tests
{
    ...
    public class WindowClientEventsBuilderTests
    {
        ...
        [Fact]
        public void OnMove_Action_param_should_set_Move_property()
        {
            Action param = () => { };
        ...
        [Fact]
        public void OnMove_String_param_should_set_Move_property()
        {
            const string param = "my_method()";

            builder.OnMove(param);

            Assert.NotNull(clientEvents.OnMove.HandlerName);
        }

        [Fact]
        public void OnMove_Action_should_return_builder()
        {
            Action param = () => { };

            var returned = builder.OnMove(param);

            Assert.IsType(typeof(WindowClientEventsBuilder), returned);
        }

        [Fact]
        public void OnMove_String_should_return_builder()
        {
            const string param = "my_method()";
