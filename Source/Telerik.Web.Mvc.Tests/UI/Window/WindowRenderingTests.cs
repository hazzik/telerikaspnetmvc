namespace Telerik.Web.Mvc.UI.Tests
{
    ...
    public class WindowRenderingTests
    {
        ...
        [Fact]
        public void ObjectWriter_should_append_Move_property_of_clientEvents()
        {
            Mock<TextWriter> writer = new Mock<TextWriter>();
            ...
            WindowTestHelper.clientSideObjectWriter.Verify(w => w.AppendClientEvent("onMove", window.ClientEvents.OnMove));
        }
