namespace Telerik.Web.Mvc.UI.Tests
{
    ...
    public class ComboBoxRenderingTests
    {
        ...
        {
            comboBox.Items.Clear();
            comboBox.Items.Add(new DropDownItem { Text = "item1", Value = "item1", Selected = true });
            ...
            ComboBoxTestHelper.clientSideObjectWriter.Setup(w => w.AppendCollection("data", It.IsAny<IEnumerable<DropDownItem>>()));

            comboBox.WriteInitializationScript(textWriter.Object);

            ComboBoxTestHelper.clientSideObjectWriter.Verify(w => w.AppendCollection("data", It.IsAny<IEnumerable<DropDownItem>>()));
        }
