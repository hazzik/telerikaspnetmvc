...
namespace Telerik.Web.Mvc.UI.Tests
{
    ...
    {
        private readonly WebAssetItemGroup group;
        private readonly WebAssetItemGroupBuilder builder;

        public WebAssetItemGroupBuilderTests()
        {
            group = new WebAssetItemGroup("foo", false) { DefaultPath = WebAssetDefaultSettings.ScriptFilesPath };
            builder = new WebAssetItemGroupBuilder(group);
        }
        ...
        {
            WebAssetItemGroup assetItem = builder;
