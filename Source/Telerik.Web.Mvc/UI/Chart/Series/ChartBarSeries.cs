...
namespace Telerik.Web.Mvc.UI
{
    ...
    public class ChartBarSeries<TModel, TValue> : ChartBoundSeries<TModel, TValue>, IChartBarSeries where TModel : class
    {
        ...
        /// </summary>
        /// <value>
        /// Can be either <see cref="ChartBarSeriesOrientation.Horizontal">horizontal</see> (bar chart)
        /// or vertical <see cref="ChartBarSeriesOrientation.Vertical">vertical</see> (column chart).
        /// The default value is horizontal.
        /// </value>
        public ChartBarSeriesOrientation Orientation
        {
            get;
            set;
        }
