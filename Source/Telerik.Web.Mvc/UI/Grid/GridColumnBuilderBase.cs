...
namespace Telerik.Web.Mvc.UI
{
    ...
    public abstract class GridColumnBuilderBase<T, TColumnBuilder> : IHideObjectMembers where TColumnBuilder : GridColumnBuilderBase<T, TColumnBuilder> where T : class
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GridColumnBuilderBase&lt;T, TColumnBuilder&gt;"/> class.
        /// </summary>
        /// <param name="column">The column.</param>
        protected GridColumnBuilderBase(GridColumn<T> column)
        {
        ...
        ///             .Name("Grid")
        ///             .Columns(columns => columns.Add(o => o.OrderID).Title("ID"))
        /// %&gt;
        /// </code>
        /// </example>
        ...
        ///  &lt;%= Html.Telerik().Grid(Model)
        ///             .Name("Grid")
        ///             .Columns(columns => columns.Add(o => o.OrderID).HeaderHtmlAttributes(new {@class="order-header"}))
        /// %&gt;
        /// </code>
        /// </example>
        ...
        ///  &lt;%= Html.Telerik().Grid(Model)
        ///             .Name("Grid")
        ///             .Columns(columns => columns.Add(o => o.OrderID).HtmlAttributes(new {@class="order-cell"}))
        /// %&gt;
        /// </code>
        /// </example>
        ...
        ///  &lt;%= Html.Telerik().Grid(Model)
        ///             .Name("Grid")
        ///             .Columns(columns => columns.Add(o => o.OrderID).Width(100))
        /// %&gt;
        /// </code>
        /// </example>
        ...
        ///  &lt;%= Html.Telerik().Grid(Model)
        ///             .Name("Grid")
        ///             .Columns(columns => columns.Add(o => o.OrderID).Visible((bool)ViewData["visible"]))
        /// %&gt;
        /// </code>
        /// </example>
