...
namespace Telerik.Web.Mvc.UI
{
    ...
    /// </summary>
    public class GridAjaxSettingsBuilder : GridRequestSettingsBuilderBase<GridAjaxSettings, GridAjaxSettingsBuilder>, IHideObjectMembers
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GridAjaxSettingsBuilder"/> class.
        /// </summary>
        /// <param name="settings">The settings.</param>
        public GridAjaxSettingsBuilder(GridAjaxSettings settings) : base(settings)
        {
        }
